namespace Recipes.Common
{
    public static class GlobalConstants
    {
        ...
        // Seeders path
        public const string CategorySeederPath = @"../../Data/Recipes.Data/Seeding/Data/Categories.json";

        public const string IngredientSeederPath = @"../../Data/Recipes.Data/Seeding/Data/Ingredients.json";
